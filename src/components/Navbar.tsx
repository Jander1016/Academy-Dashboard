...
{/*       
      ...
      <div className='flex items-center gap-6 justify-end w-full'>
        <div className='bg-white rounded-full size-7 fl items-center justify-center cursor-pointer'>
          <img src={'/message.png'} alt='Mensajes del usuario' width={20} height={20} />
        </div>
        <div className='bg-white rounded-full size-7 fl items-center justify-center cursor-pointer relative'>
          <img src={'/announcement.png'} alt='Anuncios para el usuario' width={20} height={20} />
        ...
        <img src={'/avatar.png'} alt='Avatar Usuario' width={36} height={36} className='rounded-full' />
      </div>
    </section>
  )
}
